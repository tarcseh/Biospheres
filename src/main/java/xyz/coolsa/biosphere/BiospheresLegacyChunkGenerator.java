...
/**
 * Legacy chunk generator from Biospheres v1 (master branch).
 * Uses fixed sphere radius instead of variable min/max radius.
 */
public final class BiospheresLegacyChunkGenerator extends ChunkGenerator {
	public static final MapCodec<BiospheresLegacyChunkGenerator> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
		BiomeSource.CODEC.fieldOf("biome_source").forGetter(BiospheresLegacyChunkGenerator::getBiomeSource),
		Codec.INT.optionalFieldOf("sphere_distance", 128).forGetter(BiospheresLegacyChunkGenerator::getSphereDistance),
		Codec.INT.optionalFieldOf("sphere_radius", 32).forGetter(BiospheresLegacyChunkGenerator::getSphereRadius),
		Codec.INT.optionalFieldOf("lake_radius", 16).forGetter(BiospheresLegacyChunkGenerator::getLakeRadius),
		Codec.INT.optionalFieldOf("shore_radius", 6).forGetter(BiospheresLegacyChunkGenerator::getShoreRadius),
		Codec.INT.optionalFieldOf("minimum_y", -64).forGetter(BiospheresLegacyChunkGenerator::getMinimumY),
		Codec.INT.optionalFieldOf("world_height", 384).forGetter(BiospheresLegacyChunkGenerator::getWorldHeight),
		Identifier.CODEC.optionalFieldOf("default_block", Identifier.ofVanilla("stone")).forGetter(BiospheresLegacyChunkGenerator::getDefaultBlockId),
		Identifier.CODEC.optionalFieldOf("default_fluid", Identifier.ofVanilla("water")).forGetter(BiospheresLegacyChunkGenerator::getDefaultFluidId),
		Identifier.CODEC.optionalFieldOf("default_bridge", Identifier.ofVanilla("oak_planks")).forGetter(BiospheresLegacyChunkGenerator::getDefaultBridgeId),
		Identifier.CODEC.optionalFieldOf("default_edge", Identifier.ofVanilla("oak_fence")).forGetter(BiospheresLegacyChunkGenerator::getDefaultEdgeId)
	).apply(instance, BiospheresLegacyChunkGenerator::new));
	...
	public BiospheresLegacyChunkGenerator(
	...
	public void appendDebugHudText(List<String> text, NoiseConfig noiseConfig, BlockPos pos) {
		...
		text.add("Biospheres Legacy center: " + center.toShortString());
	}
